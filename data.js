...
const COMPANIES = {
  ...
  koei: {
    ...
    items: [
      { id: "k1", category: "混合A", name: "混合A（リサイクル可能な混合：木くず・紙くず・鉄くず等）", unit: "m3", priceExcl: 9000, priceIncl: incl(9000), aliases: ["A", "混合A"] },
      { id: "k2", category: "混合B", name: "混合B（廃プラ〈軟質〉）", unit: "m3", priceExcl: 12000, priceIncl: incl(12000), aliases: ["B", "混合B"] },
      { id: "k3", category: "混合BA", name: "混合BA（がれき・ガラ・二次製品）", unit: "m3", priceExcl: 13000, priceIncl: incl(13000), aliases: ["BA", "混合BA"] },
      { id: "k4", category: "混合BB", name: "混合BB（安定型埋立・FRP・岩綿吸音板〈単品〉・陶磁器・タイル・ガラス・ALC）", unit: "m3", priceExcl: 18000, priceIncl: incl(18000), aliases: ["BB", "混合BB"] },
      { id: "k5", category: "混合C", name: "混合C（解体混合廃棄物ボード無し・反物〈ロール類〉）", unit: "m3", priceExcl: 20000, priceIncl: incl(20000), aliases: ["C", "混合C"] },
      { id: "k6", category: "混合CB", name: "混合CB（解体混合廃棄物ボード有り・岩綿吸音板〈ボード付き〉）", unit: "m3", priceExcl: 23000, priceIncl: incl(23000), aliases: ["CB", "混合CB"] },
      { id: "k7", category: "混合CC", name: "混合CC（焼却物を多く含む解体混合廃棄物）", unit: "m3", priceExcl: 25000, priceIncl: incl(25000), aliases: ["CC", "混合CC"] },
      ...
      { id: "k10", category: "石膏ボード", name: "石膏ボード単品（裸積み）", unit: "m3", priceExcl: 10000, priceIncl: incl(10000), aliases: ["ボード", "ボードA"] },
      { id: "k11", category: "石膏ボード", name: "石膏ボードB（袋入り・他の物との相積み・付着物有り）", unit: "m3", priceExcl: 12000, priceIncl: incl(12000), note: "付着物有りの場合は混合CB扱い", aliases: ["ボードB"] },
      ...
      { id: "k16", category: "焼却", name: "焼却（繊維くず〈ジュータン・布団〉・残置物・クロス・廃プラ）", unit: "m3", priceExcl: 15000, priceIncl: incl(15000), aliases: ["焼却"] },
      {
